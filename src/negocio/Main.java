...
public class Main {
	...
	private static void inicializaSistemaBancario() {
		...
		Cliente cliente01 = new Cliente(1, "Diego Alan", 31, "diegoalan@gmail.com", conta01.getId(), true);
		Cliente cliente02 = new Cliente(2, "Patrick Jose", 34, "patrickjose@gmail.com", conta02.getId(), true);
